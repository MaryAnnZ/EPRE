...
const MeshLoadInfo::ShaderLoadInfo* MeshLoadInfo::LIGHTBOX_SHADER = new ShaderLoadInfo(std::string("../kingsrow/Shader/Vertex/lightBox.vertexshader"), std::string("../kingsrow/Shader/Fragment/lightBox.fragmentshader"));
